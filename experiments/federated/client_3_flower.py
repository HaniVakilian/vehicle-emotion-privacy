...
df = pd.read_csv("data/client_3_data_V2.csv")  # 👈 Change to client_2 or client_3 in other files
...
class FlowerClient(fl.client.NumPyClient):
    ...
    # Save to CSV for plotting in Jupyter
        with open(f"results/client_3_metrics.csv", "a") as f:  # 👈 Change file name for client 2 and 3
